  ...
  17:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  1d:	7e 74                	jle    93 <main+0x93>
    ...
    {
        int pid=fork();
  1f:	e8 f7 02 00 00       	call   31b <fork>
        if(pid==0)
  24:	85 c0                	test   %eax,%eax
  26:	74 43                	je     6b <main+0x6b>
                exit();
            }
        }
        else
  ...
  2b:	6a 04                	push   $0x4
  2d:	e8 be 06 00 00       	call   6f0 <malloc>
            int *rtime=(int*)malloc(sizeof(int));
  32:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
            int *wtime=(int*)malloc(sizeof(int));
  39:	89 c3                	mov    %eax,%ebx
            int *rtime=(int*)malloc(sizeof(int));
  3b:	e8 b0 06 00 00       	call   6f0 <malloc>
  ...
  43:	89 c6                	mov    %eax,%esi
            if(waitx(wtime,rtime)==-1)
  45:	53                   	push   %ebx
  46:	e8 78 03 00 00       	call   3c3 <waitx>
  4b:	83 c4 10             	add    $0x10,%esp
  4e:	83 c0 01             	add    $0x1,%eax
  51:	74 53                	je     a6 <main+0xa6>
            {
  ...
  63:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  66:	e8 b8 02 00 00       	call   323 <exit>
            if(exec(argv[1],argv+1)<0)
  6b:	8d 43 04             	lea    0x4(%ebx),%eax
  6e:	56                   	push   %esi
  6f:	56                   	push   %esi
  70:	50                   	push   %eax
  71:	ff 73 04             	pushl  0x4(%ebx)
  74:	e8 e2 02 00 00       	call   35b <exec>
  79:	83 c4 10             	add    $0x10,%esp
  7c:	85 c0                	test   %eax,%eax
  7e:	79 e6                	jns    66 <main+0x66>
                printf(1,"exec failed");
  80:	53                   	push   %ebx
  81:	53                   	push   %ebx
  82:	68 09 08 00 00       	push   $0x809
  87:	6a 01                	push   $0x1
  ...
  93:	50                   	push   %eax
  94:	50                   	push   %eax
  95:	68 f8 07 00 00       	push   $0x7f8
  9a:	6a 01                	push   $0x1
  9c:	e8 ef 03 00 00       	call   490 <printf>
  a1:	83 c4 10             	add    $0x10,%esp
  a4:	eb c0                	jmp    66 <main+0x66>
                printf(1,"error in time thing");
  a6:	50                   	push   %eax
  a7:	50                   	push   %eax
  a8:	68 15 08 00 00       	push   $0x815
  ad:	6a 01                	push   $0x1
  af:	e8 dc 03 00 00       	call   490 <printf>
  b4:	83 c4 10             	add    $0x10,%esp
  b7:	eb 9a                	jmp    53 <main+0x53>
  b9:	66 90                	xchg   %ax,%ax
  bb:	66 90                	xchg   %ax,%ax
  bd:	66 90                	xchg   %ax,%ax
  bf:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 45 08 00 00       	mov    $0x845,%ebx
        while(*s != 0){
