...
int main(int argc, char *argv[])
{
  ...
  1b:	0f 8e 8f 00 00 00    	jle    b0 <main+0xb0>
    {
  ...
  24:	68 70 17 00 00       	push   $0x1770
  29:	e8 d2 06 00 00       	call   700 <malloc>
  ...
  4a:	58                   	pop    %eax
  4b:	5a                   	pop    %edx
  4c:	68 20 08 00 00       	push   $0x820
  51:	6a 01                	push   $0x1
  53:	e8 48 04 00 00       	call   4a0 <printf>
        for(int i=0;i<k;i++)
  58:	83 c4 10             	add    $0x10,%esp
  5b:	85 f6                	test   %esi,%esi
  5d:	7e 4c                	jle    ab <main+0xab>
  5f:	6b f6 3c             	imul   $0x3c,%esi,%esi
  62:	83 c3 04             	add    $0x4,%ebx
  65:	01 de                	add    %ebx,%esi
  ...
  73:	ff 73 34             	pushl  0x34(%ebx)
  76:	ff 73 30             	pushl  0x30(%ebx)
  79:	ff 73 2c             	pushl  0x2c(%ebx)
  7c:	ff 73 28             	pushl  0x28(%ebx)
  7f:	ff 73 24             	pushl  0x24(%ebx)
  82:	ff 73 20             	pushl  0x20(%ebx)
  85:	ff 73 1c             	pushl  0x1c(%ebx)
  88:	ff 73 18             	pushl  0x18(%ebx)
  8b:	ff 73 10             	pushl  0x10(%ebx)
  8e:	53                   	push   %ebx
  8f:	83 c3 3c             	add    $0x3c,%ebx
  92:	ff 73 d8             	pushl  -0x28(%ebx)
  95:	ff 73 c0             	pushl  -0x40(%ebx)
  98:	68 78 08 00 00       	push   $0x878
  9d:	6a 01                	push   $0x1
  9f:	e8 fc 03 00 00       	call   4a0 <printf>
        for(int i=0;i<k;i++)
  a4:	83 c4 40             	add    $0x40,%esp
  a7:	39 f3                	cmp    %esi,%ebx
  a9:	75 c5                	jne    70 <main+0x70>
    ...
    exit();
  ab:	e8 83 02 00 00       	call   333 <exit>
        printf(1, "Invalidarguments");
  b0:	51                   	push   %ecx
  b1:	51                   	push   %ecx
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 c0 08 00 00 	movzbl 0x8c0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb b9 08 00 00       	mov    $0x8b9,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 675:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	a3 70 0b 00 00       	mov    %eax,0xb70
}
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 6c9:	5d                   	pop    %ebp
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 70 0b 00 00       	mov    %eax,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 70 0b 00 00       	mov    0xb70,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 70 0b 00 00       	mov    %eax,0xb70
}
