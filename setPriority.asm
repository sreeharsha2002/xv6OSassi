  ...
  17:	83 39 02             	cmpl   $0x2,(%ecx)
{
  1a:	8b 59 04             	mov    0x4(%ecx),%ebx
    if (argc < 3)
  1d:	7e 30                	jle    4f <main+0x4f>
    {
        printf(1, "Invalidarguments\n");
    }
    else if(argv[1][0]<'0' ||argv[1][0]>'9' || argv[2][0]<'0' || argv[2][0]>'9')
  1f:	8b 43 04             	mov    0x4(%ebx),%eax
  22:	0f b6 00             	movzbl (%eax),%eax
  25:	83 e8 30             	sub    $0x30,%eax
  28:	3c 09                	cmp    $0x9,%al
  2a:	77 0d                	ja     39 <main+0x39>
  2c:	8b 53 08             	mov    0x8(%ebx),%edx
  2f:	0f b6 02             	movzbl (%edx),%eax
  32:	83 e8 30             	sub    $0x30,%eax
  35:	3c 09                	cmp    $0x9,%al
  37:	76 29                	jbe    62 <main+0x62>
    {
        printf(1,"Invalid values\n");
  39:	56                   	push   %esi
  3a:	56                   	push   %esi
  3b:	68 ea 07 00 00       	push   $0x7ea
  40:	6a 01                	push   $0x1
  ...
  47:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  4a:	e8 b4 02 00 00       	call   303 <exit>
        printf(1, "Invalidarguments\n");
  4f:	50                   	push   %eax
  50:	50                   	push   %eax
  ...
  65:	52                   	push   %edx
  66:	e8 25 02 00 00       	call   290 <atoi>
  6b:	5a                   	pop    %edx
  6c:	ff 73 04             	pushl  0x4(%ebx)
  6f:	89 c6                	mov    %eax,%esi
  71:	e8 1a 02 00 00       	call   290 <atoi>
  76:	59                   	pop    %ecx
  77:	5b                   	pop    %ebx
  78:	56                   	push   %esi
  79:	50                   	push   %eax
  7a:	e8 2c 03 00 00       	call   3ab <set_priority>
  7f:	83 c4 10             	add    $0x10,%esp
  82:	85 c0                	test   %eax,%eax
  84:	79 c4                	jns    4a <main+0x4a>
            printf(1,"Invalid options\n");
  86:	50                   	push   %eax
  87:	50                   	push   %eax
  88:	68 fa 07 00 00       	push   $0x7fa
  8d:	6a 01                	push   $0x1
  8f:	e8 dc 03 00 00       	call   470 <printf>
  94:	83 c4 10             	add    $0x10,%esp
  97:	eb b1                	jmp    4a <main+0x4a>
  99:	66 90                	xchg   %ax,%ax
  9b:	66 90                	xchg   %ax,%ax
  9d:	66 90                	xchg   %ax,%ax
  9f:	90                   	nop
